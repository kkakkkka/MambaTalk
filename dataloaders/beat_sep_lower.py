    ...
    def cache_generation(self, out_lmdb_dir, disable_filtering, clean_first_seconds,  clean_final_seconds, is_test=False):
        ...
        for index, file_name in self.selected_file.iterrows():
            ...
            if self.args.audio_rep is not None:
                ...
                if self.args.audio_rep == "onset+amplitude":
                ...
                elif self.args.audio_rep == "amplitude+ctc+audio":
                    audio_each_file_tmp = audio_each_file.copy()
                    ...
                    predicted_ids = predicted_ids.squeeze().numpy()
                    
                    audio_length = len(audio_each_file)  # 816000
                    predicted_length = len(predicted_ids)  # 2789
                    ...
                    #print(f"audio_each_file:{audio_each_file.shape}")  
