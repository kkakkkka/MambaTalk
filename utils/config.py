...
def parse_args():
    ...
    parser.add("-c", "--config", default='./configs/mambatalk.yaml', is_config_file=True)
    ...
    parser.add("--resume", default="", type=str) 
...
#    parser.add("--id_rep", default=None, type=str)
    ...
    parser.add("--test_start_epoch", default=80, type=int)    
...
#    parser.add("--gan_noise_size", default=0, type=int)
    ...
    parser.add("--port", default=8690, type=int)
